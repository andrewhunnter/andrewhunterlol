    ...
    return (
        <div className="social-buttons-container">
            ...
            <div className="social-buttons">
                ...
                <a href="https://t.me/andrewhunnter" className="social-button telegram" target="_blank" rel="noopener noreferrer">
                    <span className="iconify" data-icon="mdi:telegram"></span>
                </a>
                <a href="https://tiktok.com/@andrewhunnter" className="social-button tiktok" target="_blank" rel="noopener noreferrer">
